                                                    ...
                                                    {{ __('lang.N° of Guests :') }} <span
                                                        ...
                                                        <ul class="ml-1 ">
                                                            ...
                                                            <li class="relative text-black left-1">Children :
                                                                {{ $children }}</li>
                                                            <li class="text-black">Infants : {{ $infants }}</li>
                                                        </ul>
                                                    </span>
                                        ...
                                        <div class=" ml-2">
                                            @if ($room)
                                                ...
                                                <p class="text-gray-500 font-semibold">{{ __('lang.Name :') }} <span
                                                        class="text-gray-700">{{ ucfirst($room->name) }}</span></p>
                                                @if ($typeroom)
                            ...
                            <form method="POST" wire:submit.prevent="submit">
                                ...
                                <div class="  pb-2 mr-2 ml-2 mb-2  border border-b-2 border-gray-200   ">
                                    ...
                                    <div class="grid grid-cols-2 sm:col-span-4 lg:col-span-2">
                                        ...
                                        <div
                                            ...
                                            <h3 class="relative top-3 pt-2 font-semibold text-black">Add Amenities
                                            </h3>
                                ...
                                <div>
                                    <button type="submit" wire:click="bookNow" wire:loading.attr="disabled"
                                        class="bg-violet-600 text-white py-2 px-6 rounded-md hover:bg-yellow-500 focus:ring-2 focus:ring-yellow-400 focus:outline-none transition duration-300 h-9 font-semibold w-32 relative left-3/4 ">
