    ...
    <form wire:submit.prevent="submitBooking">
        <div class="flex flex-wrap gap-10">
            ...
            <div
                ...
                <h2 class="font-bold text-violet-600 left-9 py-8 relative">{{ __('lang.User Information') }}</h2>
                <input type="text" wire:model="name" placeholder="{{ __('lang.Full Name') }}" required
                    class="form-control py-5">
                <input type="email" wire:model="email" placeholder="{{ __('lang.Email') }}" required
                    class="form-control">
                <input type="text" wire:model="phone" placeholder="{{ __('lang.Phone') }}" required
                    class="form-control">
                <!-- Room Capacity Section -->

                <h3 class="font-bold text-violet-600 relative left-9 py-10">{{ __('lang.Reservation Information') }}
                </h3>
                @if ($roomType)
                    <div class="tour_package_details_bar_list">
                        <h5 class="font-bold relative left-9 ">{{ __('lang.Room Capacity') }} :
                            {{ $roomType->room_capacity }}</h5>
                        <div class="select_person_item">
                            <div class="select_person_left">
                                <h6>{{ __('lang.Capacity') }}</h6>
                            </div>
                ...
                @else
                    <p class="text-gray-500 relative left-20">{{ __('lang.Select a room to view capacity options .') }}
                    </p>
                @endif
                <div>
                    <div class="select_person_item">
                        <div class="select_person_left">
                            <h6 class="font-bold">{{ __('lang.Adults number') }}</h6>
                            <p>12y+</p>
                        </div>
                        <div class="select_person_right">
                            <button class="rounded-none border-none focus:outline-none bg-white" type="button"
                    ...
                    <div class="select_person_item">
                        <div class="select_person_left">
                            <h6 class="font-bold">{{ __('lang.Children number') }}</h6>
                            <p>2 - 12 {{ __('lang.years') }}</p>
                        </div>
                        <div class="select_person_right">
                            <button class="rounded-none border-none focus:outline-none bg-white" type="button"
                    ...
                    <div class="select_person_item">
                        <div class="select_person_left">
                            <h6 class="font-bold">{{ __('lang.Infants number') }}</h6>
                            <p>{{ __('lang.Below') }} 2 {{ __('lang.years') }}</p>
                        </div>
                        <div class="select_person_right">
                            <button class="rounded-none border-none focus:outline-none bg-white" type="button"
            ...
            <div
                ...
                <h2 class="font-bold text-violet-600 left-9 relative">{{ __('lang.Booking Details') }}</h2>
                <h4 class="text-slate-600 font-semibold py-5 left-9 relative">{{ __('lang.Reservation Dates') }}</h4>
                ...
                <h4 class="text-slate-600 font-semibold py-5 left-9 relative">{{ __('lang.Room Selection') }}</h4>
                <select wire:model="hotel_id" wire:change="loadHotelDetails" class="form-control">
                    <option value="" class="text-gray-500 rounded-lg">{{ __('lang.Select Hotel') }}</option>
                    @foreach ($hotels as $hotel)
                        <option value="{{ $hotel->id }}">{{ $hotel->name }}</option>
                    @endforeach
                </select>
                <select wire:model="roomtype_id" wire:change="loadRoomPrice" class="form-control">
                    <option value="">{{ __('lang.Select Room') }}</option>
                    @foreach ($roomTypes as $roomType)
                        <option value="{{ $roomType->id }}">{{ $roomType->name }} : {{ $roomType->room->type }} (
                            {{ $roomType->price }} TND/per night)
                        </option>
                    @endforeach
                </select>

                <div
                    class=" py-10 bg-white rounded-2xl hover:bg-white hover:shadow-lg shadow-xl transition duration-300 relative top-10 ">
                    <!-- Price Per Night -->

                    <label for="price_per_night"
                        class="font-bold text-violet-600 relative left-10">{{ __('lang.Price Per Night :') }}
                    </label>
                    ...
                    <h3 class="text-violet-600 font-bold text-xl relative top-4 left-10">{{ __('lang.Total Price :') }}
                        <span>{{ $total_price }}
                            {{ __('lang.TND') }}</span>
                    </h3>
                </div>
        ...
        <button type="submit"
            class="px-4 py-2 font-bold text-white rounded-full hover:bg-yellow-500 bg-violet-600 top-10 relative left-52">{{ __('lang.Submit Booking') }}</button>
