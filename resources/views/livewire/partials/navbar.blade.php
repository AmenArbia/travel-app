<div>
                ...
                <div class="col-lg-12">
                    <div class="common_bannner_text">
                        <h2 class="text-violet-800 font-bold text-6xl"><a href="/"
                                class="text-violet-800 font-bold ">{{ __('lang.Travel Shaper') }}</a>
                        </h2>
                        <ul>
    ...
    <style>
        #common_banner {
            background-image: url('{{ asset('storage/photos/hotel-pool-with-mosaictiled-bottom-swimup-bar-serving-refreshing-beverages.jpg') }}');
