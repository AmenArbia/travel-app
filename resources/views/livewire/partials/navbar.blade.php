    ...
    <div class="container" style="width: 100%;">
        ...
        <section id="common_banner">
            ...
            <div class="content-container">
                <div class="container">
                    <div class="text-violet-800 font-bold text-5xl pt-3 rounded-full   " style="background: #ffffff4d;">
                        <div class="row">
                            <div class="flex flex-col items-center text-center">
                                <div class="mb-2">
                                    <a href="/"
                                        class="text-violet-800 font-bold p-5 rounded-md no-underline text-3xl">
                                ...
                                <nav class="mb-1" aria-label="Breadcrumb">
                                    <ol class="inline-flex items-center space-x-1 md:space-x-1 rtl:space-x-reverse">
                                        <li class="inline-flex items-center">
                                            <a href="/"
                                                class="inline-flex items-center text-sm font-medium text-violet-700 hover:text-blue-600 dark:hover:text-white">
